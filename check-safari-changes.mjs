...
const paths = [
  { old: 'html.manifest', new: 'manifests.webapp.name', feature: 'Web App Manifest' },
  { old: 'api.Web_Authentication_API', new: 'api.PublicKeyCredential', feature: 'WebAuthn' },
  { old: 'api.URL.createObjectURL', new: 'api.URL.createObjectURL_static', feature: 'Blob URLs' },
  { old: 'javascript.builtins.WebAssembly', new: 'webassembly.api', feature: 'WebAssembly' },
  { old: 'javascript.builtins.WebAssembly.instantiate', new: 'webassembly.api.instantiate_static', feature: 'WASM instantiate' },
  { old: 'api.Window.isSecureContext', new: 'api.isSecureContext', feature: 'isSecureContext' }
];
